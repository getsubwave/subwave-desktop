...
const default_native_sdk_path ="/home/klair/.local/share/mise/installs/node/24.19.0/lib/node_modules/@native-sdk/cli";
const app_exe_name = "webview-player";
...
pub fn build(b: *std.Build) void {
    ...
    const native_sdk_path = b.option([]const u8, "native-sdk-path", "Path to the Native SDK framework checkout") orelse
        b.graph.environ_map.get("NATIVE_SDK_PATH") orelse default_native_sdk_path;
